...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-obsidian-950 overflow-x-hidden">
      {/* ─── Navigation ─────────────────────────────────────── */}
      <nav className="fixed top-0 inset-x-0 z-40 flex items-center justify-between px-8 py-4 bg-obsidian-950/80 backdrop-blur-md border-b border-white/[0.04]">
        {/* Gauche : logo Zero to One + séparateur + FêtEasy */}
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center pt-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-gold-600/5 blur-[120px]" />
          <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] rounded-full bg-gold-800/4 blur-[100px]" />
          <div
        ...
        <div className="absolute top-24 left-8 ornament-corner" />
        <div
          className="absolute top-24 right-8 ornament-corner"
          style={{ transform: "scaleX(-1)" }}
        />
        <div
          className="absolute bottom-8 left-8 ornament-corner"
          style={{ transform: "scaleY(-1)" }}
        />
        <div
          className="absolute bottom-8 right-8 ornament-corner"
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <p
            className="text-obsidian-400 font-body font-light text-base leading-relaxed mb-10 max-w-xl mx-auto animate-fade-up"
          ...
          <div
            className="flex items-center justify-center flex-wrap gap-3 animate-fade-up"
            style={{ animationDelay: "0.35s" }}
          >
            <Link
              href="/register"
              className="group inline-flex items-center gap-3 bg-gold-700 hover:bg-gold-600 text-obsidian-950 border border-gold-600 hover:border-gold-400 transition-all text-[0.55rem] tracking-[0.3em] uppercase font-body font-light px-8 py-4 rounded-xl"
            >
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 text-[0.55rem] tracking-[0.3em] uppercase font-body font-light text-obsidian-400 hover:text-gold-400 transition-colors px-8 py-4 border border-obsidian-800 hover:border-gold-900 rounded-xl"
            >
              Se connecter
            </Link>
          </div>
      ...
      {/* ─── Screenshots ──────────────────────────────────────── */}
      <section className="py-24 px-6 border-y border-obsidian-900 overflow-hidden">
      ...
      <section id="features" className="py-32 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={title}
              className="group bg-obsidian-900 border border-obsidian-800 rounded-2xl p-7 hover:border-gold-900/60 transition-all duration-300 hover:-translate-y-1"
            >
      ...
      {/* ─── How it works ─────────────────────────────────────── */}
      <section id="how" className="py-24 px-6 border-y border-obsidian-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[0.5rem] tracking-[0.4em] uppercase text-gold-700 mb-3 font-body font-light">
              Comment ça marche
            </p>
            <h2 className="font-display font-light text-4xl text-white">
              En 3 étapes simples
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={n} className="text-center">
                <p className="font-display text-6xl font-light text-gold-900 mb-4">
                  {n}
                </p>
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={a}
              className="bg-obsidian-900 border border-obsidian-800 rounded-2xl p-7"
            >
      ...
      <section className="py-32 px-6">
        <div className="max-w-2xl mx-auto text-center border border-gold-900/30 rounded-3xl p-16 relative overflow-hidden bg-gold-950/10">
          <div className="absolute inset-0 bg-gradient-radial from-gold-900/10 to-transparent pointer-events-none" />
          <p className="text-[0.52rem] tracking-[0.4em] uppercase text-gold-600 mb-4 font-body font-light relative">
            Prêt à commencer ?
          </p>
          <h2 className="font-display font-light text-4xl md:text-5xl text-white mb-6 relative">
            Créez votre premier
            <br />
            <em className="text-gold-shimmer">événement</em>
          </h2>
          <p className="text-obsidian-500 font-body font-light text-sm mb-10 relative">
            Gratuit, sans carte bancaire, sans limite d&apos;invités.
          </p>
          <Link
            href="/register"
            className="group inline-flex items-center gap-3 bg-gold-700 hover:bg-gold-600 text-obsidian-950 border border-gold-600 hover:border-gold-400 transition-all text-[0.55rem] tracking-[0.3em] uppercase font-body font-light px-10 py-4 rounded-xl relative"
          >
